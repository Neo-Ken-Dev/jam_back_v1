...
class __TwigTemplate_27a3b4af828caa94f6a71c17cb4f0d15 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  98 => 12,  94 => 11,  89 => 8,  79 => 7,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <div class=\"row\">
        <div class=\"row d-flex justify-content-center align-items-center h-100\">
            <div class=\"col-12\">
                <h2>Merci {{  app.user.email }}</h2>
                <p>Commande numéro {{ order.id }} }} validée.</p>
            </div>
        </div>
    </div>
{% endblock %}
", "checkout/success.html.twig", "/home/hub-grade/Documents/3wa/refacto/jam_back_v1/templates/checkout/success.html.twig");
    }
}
