...
class __TwigTemplate_beee54d30653af3fce42aa8a3ea24d2b extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        if ((isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 7, $this->source); })())) {
            // line 8
            echo "            <div>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["error"]) || array_key_exists("error", $context) ? $context["error"] : (function () { throw new RuntimeError('Variable "error" does not exist.', 8, $this->source); })()), "message", [], "any", false, false, false, 8), "html", null, true);
            echo "</div>
        ";
        }
        // line 10
...
";
    ...
    {
        return array (  129 => 32,  109 => 15,  103 => 12,  99 => 10,  93 => 8,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <div class=\"row col-6\">
        ...
        <form action=\"{{ path('login') }}\" method=\"post\">
            ...
            <!-- Register buttons -->
            <div class=\"text-center\">
                <p>Not a member? <a href=\"{{ path('register') }}\">Register</a></p>
            </div>
        </form>
    </div>
{% endblock %}

", "login/index.html.twig", "/home/hub-grade/Documents/3wa/refacto/back aymeric/application-jam-test-api-platform/templates/login/index.html.twig");
    }
}
