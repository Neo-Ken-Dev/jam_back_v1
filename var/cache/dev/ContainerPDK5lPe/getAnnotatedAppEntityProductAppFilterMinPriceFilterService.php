 ...
 */
class getAnnotatedAppEntityProductAppFilterMinPriceFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'annotated_app_entity_product_app_filter_min_price_filter' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['annotated_app_entity_product_app_filter_min_price_filter'] = new \App\Filter\MinPriceFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), ($container->privates['monolog.logger'] ?? $container->getMonolog_LoggerService()));
    }
}
