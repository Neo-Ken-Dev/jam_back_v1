...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('pY34bXKD+r', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ZgHJ+55x1+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('oAN9Sp0fvb', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\LineOrderRepository' => ['privates', 'App\\Repository\\LineOrderRepository', 'getLineOrderRepositoryService', true],
    ...
    protected function getHttpKernelService()
    {
        ...
        return $this->services['http_kernel'] = new \Symfony\Component\HttpKernel\HttpKernel($a, ($this->privates['debug.controller_resolver'] ?? $this->getDebug_ControllerResolverService()), ($this->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), new \Symfony\Component\HttpKernel\Controller\TraceableArgumentResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver(($this->privates['argument_metadata_factory'] ??= new \Symfony\Component\HttpKernel\ControllerMetadata\ArgumentMetadataFactory()), new RewindableGenerator(function () {
            ...
            yield 10 => ($this->privates['debug.api_platform.argument_resolver.payload'] ?? $this->load('getDebug_ApiPlatform_ArgumentResolver_PayloadService'));
        ...
        }, 15)), ($this->privates['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true))), false);
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WAR8Yd08Wr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('f2f2tjBQhh', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MEuM8Kl2qv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3aZoHgLZRL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Filter\\MaxPriceFilter' => ['privates', 'App\\Filter\\MaxPriceFilter', 'getMaxPriceFilterService', true],
            'App\\Filter\\MinPriceFilter' => ['privates', 'App\\Filter\\MinPriceFilter', 'getMinPriceFilterService', true],
            ...
            'annotated_app_entity_product_app_filter_max_price_filter' => ['privates', 'annotated_app_entity_product_app_filter_max_price_filter', 'getAnnotatedAppEntityProductAppFilterMaxPriceFilterService', true],
            'annotated_app_entity_product_app_filter_min_price_filter' => ['privates', 'annotated_app_entity_product_app_filter_min_price_filter', 'getAnnotatedAppEntityProductAppFilterMinPriceFilterService', true],
        ], [
            'App\\Filter\\MaxPriceFilter' => '?',
            'App\\Filter\\MinPriceFilter' => '?',
            'annotated_app_entity_product_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_product_app_filter_max_price_filter' => '?',
            'annotated_app_entity_product_app_filter_min_price_filter' => '?',
        ]);
    }
    ...
    protected function getApiPlatform_Serializer_ContextBuilder_FilterService()
    {
        ...
        $b = ($this->privates['api_platform.filter_locator'] ?? $this->getApiPlatform_FilterLocatorService());

        if (isset($this->privates['api_platform.serializer.context_builder.filter'])) {
            return $this->privates['api_platform.serializer.context_builder.filter'];
        }

        return $this->privates['api_platform.serializer.context_builder.filter'] = new \ApiPlatform\Serializer\SerializerFilterContextBuilder($a, $b, new \ApiPlatform\Serializer\SerializerContextBuilder($a, true));
    }
    ...
    protected function getApiPlatform_Symfony_IriConverterService()
    {
        ...
        $f = ($this->privates['api_platform.metadata.operation.metadata_factory'] ?? $this->getApiPlatform_Metadata_Operation_MetadataFactoryService());
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NKAEWX8SNk', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('EloYBCqfIb', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService()));
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('7v6jZf3DUw', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QF-ApDE3+S', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MWUSPERkXa', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ddErpq09zV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getSerializerService()
    {
        ...
        $g = new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL);

        $h = new \ApiPlatform\OpenApi\Serializer\LegacyOpenApiNormalizer(new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $f, $a)], [0 => $g]))));
        ...
        $o = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $k, $l, $m, $d, $f, $i, $n, [], $e);
        $p = new \ApiPlatform\Serializer\ItemNormalizer($c, $k, $l, $m, $f, $i, $n, NULL, $b, $e);
        $q = new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($n);
        $r = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($n, $i, $f, $a, $q, NULL);
        $s = new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL);

        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($f), 1 => $h, 2 => $h, 3 => new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $i), 4 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($j, [], $i), 5 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $i), 6 => $h, 7 => new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($o, $i), 8 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $k, $m, $j, $i), 9 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $l, $j), 10 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($j, true, []), 11 => new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($p, $i), 12 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true, []), 13 => new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), 14 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 15 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 16 => $o, 17 => $p, 18 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 19 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $i), 20 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($n, $i, $a, $q, NULL)), 21 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 23 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 24 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 25 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 26 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 27 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($d, $m, $l, NULL), 'page', 'pagination', $b, $f), $b, $m, ($this->privates['api_platform.filter_locator'] ?? $this->getApiPlatform_FilterLocatorService())), 28 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 29 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($r, $l, $d), 30 => $r], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $g, 2 => $s, 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), 5 => new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $s), 6 => new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), 7 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getTwigService()
    {
        ...
        $g = ($this->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack());
        ...
        $instance->addGlobal('codeTva', $this->parameters['codeTva']);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.title' => 'Jam Documentation from API Platform',
